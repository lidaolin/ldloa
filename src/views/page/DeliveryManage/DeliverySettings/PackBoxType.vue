    ...
    return{
      ...
      tableDataInfo:{ //表格信息
        dataListInfo:[
          ...
          {prop:'longsize',label:'长',unit:'cm',sortable:"custom"},
          {prop:'widesize',label:'宽',unit:'cm',sortable:"custom"},
          {prop:'highsize',label:'高',unit:'cm',sortable:"custom"},
          {prop:'volumesize',label:'体积',unit:'cm³',sortable:"custom"},
          {prop:'packnumber',label:'最多可以装商品的数量',sortable:"custom"},
