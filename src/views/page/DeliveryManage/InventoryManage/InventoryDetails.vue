...
import {stockDetailedList,} from "@/api/DeliveryManage/InventoryManage/InventoryDetails";
...
export default {
    ...
    return{
      ...
      tableDataInfo:{ //表格信息
        dataListInfo:[
          ...
          {prop:'stock_details_type',label:'明细来源',},
          {prop:'stock_details_code',label:'单号',width:160,},
          {prop:'code_company_id',label:'单号所属单位',},
  ...
  methods:{
    ...
    getList(){
      stockDetailedList(this.pagingData).then(res=>{
        this.pagingData={...
              this.pagingData,
